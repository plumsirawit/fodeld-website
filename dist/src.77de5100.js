...
var typewriter = function typewriter(str, t, callbackFn) {
  if (t === void 0) {
    t = 100;
  }
...
document.addEventListener('DOMContentLoaded', function () {
  typewriter('Fodeld', 100, function (str) {
    document.getElementById('mainLabel').innerHTML = str;
  }).then(function () {
    typewriter('An innovative solution to reduce hunger during self-lockdown', 70, function (str) {
